...
class SolGuiSystem : ModuleSystemBase() {
    override fun onSetup() {
        usingComponents(CharacterComp::class.java, HurtboxComp::class.java, TransformComp::class.java, TeamPlayerComp::class.java)
    ...
    override fun onUpdate() {
        ...
        { entity, hurtboxComp, transComp, teamPlayerComp ->
