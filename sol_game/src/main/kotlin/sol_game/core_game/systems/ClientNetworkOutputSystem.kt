...
class ClientNetworkOutputSystem() : ModuleSystemBase() {
    ...
    override fun onStart() {
        getModule(NetworkClientModule::class.java).usePacketTypes(SolActions::class.java)
    }

    override fun onUpdate() {
        forEachWithComponents(SolActionsPacketComp::class.java) { _, actionsPacketComp ->
            getModule(NetworkClientModule::class.java).sendPacket(actionsPacketComp.actions)
        }
    }
}